...
public class BegCyberQuiz extends AppCompatActivity {
    private TextView questionText, questionCounter;
    private RadioGroup radioGroup;
    private RadioButton answer1, answer2, answer3;
    private Button nextButton;
    private Button submitButton;
    private String currentQuizTitle = "Beginner Cyber Security Quiz";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.beginner_quiz3);
        ...
        questions.add(new QuizQuestionLogic(
                getString(R.string.begCyber_question_1),
                new String[]{
                        getString(R.string.begCyberQ1A1Answer),
        ...
        questions.add(new QuizQuestionLogic(
                getString(R.string.begCyber_question_2),
                new String[]{
                        getString(R.string.begCyberQ2A1Answer),
        ...
        questions.add(new QuizQuestionLogic(
                getString(R.string.begCyber_question_3),
                new String[]{
                        getString(R.string.begCyberQ3A1Answer),
                        getString(R.string.begCyberQ3A2Answer),
                        getString(R.string.begCyberQ3A3Answer)
                },
                1
        ));

        questions.add(new QuizQuestionLogic(
                getString(R.string.begCyber_question_4),
                new String[]{
                        getString(R.string.begCyberQ4A1Answer),
        ...
        questions.add(new QuizQuestionLogic(
                getString(R.string.begCyber_question_5),
                new String[]{
                        getString(R.string.begCyberQ5A2Answer),
...
//                Toast.LENGTH_LONG).show();
    ...
    private void goToResults(int score, int totalQuestions, String quizTitle) {
        ...
        Intent intent = new Intent(BegCyberQuiz.this, QuizResults.class);
