...
public class BegDevQuiz extends AppCompatActivity {
    private TextView questionText, questionCounter;
    private RadioGroup radioGroup;
    private RadioButton answer1, answer2, answer3;
    private Button nextButton;
    private Button submitButton;
    private String currentQuizTitle = "Beginner Device Security Quiz";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.beginner_quiz2); //device quiz
        ...
        questions.add(new QuizQuestionLogic(
                getString(R.string.begDev_question_1),
                new String[]{
                        getString(R.string.begDevQ1A1Answer),
                        getString(R.string.begDevQ1A2Answer),
                        getString(R.string.begDevQ1A3Answer),
                },
                0 // correct answer index
        ));

        questions.add(new QuizQuestionLogic(
                getString(R.string.begDev_question_2),
                new String[]{
                        getString(R.string.begDevQ2A1Answer),
                        getString(R.string.begDevQ2A2Answer),
                        getString(R.string.begDevQ2A3Answer)
                },
                1
        ));

        questions.add(new QuizQuestionLogic(
                getString(R.string.begDev_question_3),
                new String[]{
                        getString(R.string.begDevQ3A1Answer),
                        getString(R.string.begDevQ3A2Answer),
                        getString(R.string.begDevQ3A3Answer)
                },
                1
        ));

        questions.add(new QuizQuestionLogic(
                getString(R.string.begDev_question_4),
                new String[]{
                        getString(R.string.begDevQ4A1Answer),
                        getString(R.string.begDevQ4A2Answer),
                        getString(R.string.begDevQ4A3Answer)
                },
                1
        ));

        questions.add(new QuizQuestionLogic(
                getString(R.string.begDev_question_5),
                new String[]{
                        getString(R.string.begDevQ5A2Answer),
                        getString(R.string.begDevQ5A3Answer),
                        getString(R.string.begDevQ5A1Answer),
                },
                1
        ));
...
//                Toast.LENGTH_LONG).show();
    ...
    private void goToResults(int score, int totalQuestions, String quizTitle) {
        ...
        Intent intent = new Intent(BegDevQuiz.this, QuizResults.class);
