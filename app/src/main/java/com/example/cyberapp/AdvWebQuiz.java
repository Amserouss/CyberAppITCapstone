...
public class AdvWebQuiz extends AppCompatActivity {
    private TextView questionText, questionCounter;
    private RadioGroup radioGroup;
    private RadioButton answer1, answer2, answer3;
    private Button nextButton;
    private Button submitButton;
    private String currentQuizTitle = "Advanced Web Security Quiz";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.advanced_quiz1);
...
//                Toast.LENGTH_LONG).show();
    ...
    private void goToResults(int score, int totalQuestions, String quizTitle) {
        ...
        Intent intent = new Intent(AdvWebQuiz.this, QuizResults.class);
