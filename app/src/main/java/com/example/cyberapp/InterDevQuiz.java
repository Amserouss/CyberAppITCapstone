...
public class InterDevQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inter_quiz2);
        ...
        questions.add(new QuizQuestionLogic(
                getString(R.string.interDev_question_1),
                new String[]{
                        getString(R.string.interDevQ1A1Answer),
        ...
        questions.add(new QuizQuestionLogic(
                getString(R.string.interDev_question_2),
                new String[]{
                        getString(R.string.interDevQ2A1Answer),
        ...
        questions.add(new QuizQuestionLogic(
                getString(R.string.interDev_question_3),
                new String[]{
                        getString(R.string.interDevQ3A1Answer),
        ...
        questions.add(new QuizQuestionLogic(
                getString(R.string.interDev_question_4),
                new String[]{
                        getString(R.string.interDevQ4A1Answer),
                        getString(R.string.interDevQ4A2Answer),
                        getString(R.string.interDevQ4A3Answer)
                },
                1
        ));

        questions.add(new QuizQuestionLogic(
                getString(R.string.interDev_question_5),
                new String[]{
                        getString(R.string.interDevQ5A2Answer),
...
//                Toast.LENGTH_LONG).show();
    ...
    private void goToResults(int score, int totalQuestions, String quizTitle) {
        ...
        Intent intent = new Intent(InterDevQuiz.this, QuizResults.class);
